...
import { TIMEOUT, TRANSITION_KEYS, TRANSITION_CLASS_MAP } from '../constants/constants'
...
export class Collapse extends React.Component {
  ...
  render () {
    const { tag: Tag, open, className, navbar, children, innerRef, ...attrs } = this.props
  ...
  onEntering (node, isAppearing) {
    this.setState({ height: layoutUtils.getNodeHeight(node) })
