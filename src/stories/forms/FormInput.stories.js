  ...
  return (
    <>
      <FormInput {...componentKnobs} theme={theme} placeholder='Prepender'>
        <FormInputAddon type='prepend' theme={theme}>$</FormInputAddon>
      </FormInput>
      <FormInput {...componentKnobs} theme={theme} placeholder='Appender'>
        <FormInputAddon type='append' theme={theme}>$</FormInputAddon>
      </FormInput>
      <FormInput {...componentKnobs} theme={theme} placeholder='Both'>
        <FormInputAddon type='prepend' theme={theme}>$</FormInputAddon>
        <FormInputAddon type='append' theme={theme}>.00</FormInputAddon>
      </FormInput>
      <FormInput {...componentKnobs} theme={theme} placeholder='Leading'>
        <FormInputAddon type='leading' theme={theme}>
          <svg version='1.1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 32 32' width='16' height='auto'>
            <path d='M31.6,31.7c-0.2,0.2-0.5,0.3-0.7,0.3s-0.5-0.1-0.7-0.3L19.7,21.2C17.6,22.9,14.9,24,12,24C5.4,24,0,18.6,0,12
      ...
      <FormInput {...componentKnobs} theme={theme} placeholder='Leading'>
        <FormInputAddon type='trailing' theme={theme}>
          <svg version='1.1' xmlns='http://www.w3.org/2000/svg' width='16' height='auto' viewBox='0 0 32 32'>
